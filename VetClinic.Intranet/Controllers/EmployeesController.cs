...
namespace VetClinic.Intranet.Controllers
{
    public class EmployeesController : Controller
    {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("EmployeeId,EmployeeName,EmployeeSurname,EmployeeTitle,EmployeePosition,EmployeeEducation,EmployeeBio,EmployeePhotoURL,EmployeeIsActive")] Employee employee)
        {
